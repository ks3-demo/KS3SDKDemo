...
//  KS3iOSSDKDemo
//
//  Created by cqc on 12/17/14.
//  Copyright (c) 2014 cqc. All rights reserved.
//
...
/*
  ...
  开发前请阅读： KS3 - iOS -SDK 文档地址 https://github.com/ks3sdk/newks3-ios-sdk
...
//上传
#define kUploadBucketName @"ks3tools-test"   //上传所用的bucketName
#define kUploadBucketKey @"7.6M.mov"  //上传时用到的bucket里文件的路径，此为在wz目录下7.6M.mov
...
#define kDesBucketName @"cqc11"//@"ggg"//
...
//    [[KS3Client initialize] setCredentials:[[KS3Credentials alloc] initWithAccessKey:strAccessKey withSecretKey:strSecretKey]];
    ...
    _arrItems = [NSArray arrayWithObjects:
                 ...
                 @"Multipart Upload", @"Pause Download", @"Abort Upload", @"Upload Manager", @"Put Object 1M", @"Put Object 5M", @"Put Object 10M", @"Put Object 50M", @"Put Object ByAppServerToken", nil];
...
//    [acl setGrantControlAccess:KingSoftYun_Grant_Permission_Read];
    ...
    putObjRequest.strDate = @"Mon, 11 Jan 2021 04:37:21 GMT";
    ...
    NSDictionary *httpHeaders = putObjRequest.urlRequest.allHTTPHeaderFields;
    NSLog(@"Request Headers is %@",httpHeaders);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    switch (indexPath.row) {
        ...
        case 8:
        {
            ...
            acl.displayName = @"cqc111DisplayName";
            [acl setGrantControlAccess:KingSoftYun_Grant_Permission_Read];
